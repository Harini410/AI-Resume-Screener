          ...
          {totalResumes === 0 ? (
            <Card className="border-2 border-primary/10">
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-lg font-medium mb-2">No screened candidates yet</h3>
                <p className="text-muted-foreground mb-4">
                  Select and screen candidate profiles against job requirements in the Screener Studio to view telemetry here
                </p>
                <Button
                  asChild
              ...
              <div className="grid md:grid-cols-4 gap-6 mb-8">
                <Card className="border-2 border-primary/10 hover:border-primary/20 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Screened Profiles</CardTitle>
                    <FileText className="h-4 w-4 text-primary" />
                  </CardHeader>
                  <CardContent>
                    <div className="text-3xl font-bold text-primary">{totalResumes}</div>
                    <p className="text-xs text-muted-foreground">Screened candidates</p>
                  </CardContent>
                </Card>
